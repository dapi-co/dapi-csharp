...
namespace Dapi.Response {
    public class CreateBeneficiaryResponse : BaseResponse {
        /// <summary>
        /// This is used only to automate the deserialization of the got response.
        /// This is a private constructor to this lib.
        /// </summary>
        [JsonConstructor]
        internal CreateBeneficiaryResponse(APIStatus status, bool success, string operationID, UserInput[] userInputs, string type, string msg) :
        ...
        /// This is a private constructor to this lib.
        /// </summary>
        internal CreateBeneficiaryResponse(string errType, string errMsg) : base(errType, errMsg) {
        }
    }
}
