...
namespace Dapi.Response {
    public class GetEnrichedTransactionsResponse : BaseResponse {
        public EnrichedTransaction[] transactions { get; }
        ...
        /// </summary>
        [JsonConstructor]
        internal GetEnrichedTransactionsResponse(EnrichedTransaction[] transactions, APIStatus status, bool success, string operationID, UserInput[] userInputs, string type, string msg) :
