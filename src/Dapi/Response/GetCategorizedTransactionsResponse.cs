...
namespace Dapi.Response {
    public class GetCategorizedTransactionsResponse : BaseResponse {
        ...
        /// </summary>
        [JsonConstructor]
        internal GetCategorizedTransactionsResponse(CategorizedTransaction[] transactions, APIStatus status, bool success, string operationID, UserInput[] userInputs, string type, string msg) :
        ...
        /// This is a private constructor to this lib.
        /// </summary>
        internal GetCategorizedTransactionsResponse(string errType, string errMsg) : base(errType, errMsg) {
        }
    }
}
