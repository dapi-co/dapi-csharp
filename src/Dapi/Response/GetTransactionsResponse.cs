...
namespace Dapi.Response {
    public class GetTransactionsResponse : BaseResponse {
        ...
        /// </summary>
        [JsonConstructor]
        internal GetTransactionsResponse(Transaction[] transactions, APIStatus status, bool success, string operationID, UserInput[] userInputs, string type, string msg) :
        ...
        /// This is a private constructor to this lib.
        /// </summary>
        internal GetTransactionsResponse(string errType, string errMsg) : base(errType, errMsg) {
        }
    }
}
